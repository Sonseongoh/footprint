...
### Major (출시 전 권장) — 전부 완료 2026-07-06
- [x] 7일 지나면 내 여행 공유 삭제 불가 (280fa35 — 삭제 상시 허용 + 사진 정리)
- [x] 체크인 사진 여러 장 첫 장만 열람 (acc34d7 — 뷰어 스와이프/화살표/카운터/탭 토글)
- [x] 구글 로그인 실패 무음 (280fa35 — 성공/실패 알림)
- [x] 첫 실행 탭 → 지구본 (280fa35 — globe↔index 스왑)
- [x] 지구본 같은 나라 재탭 동기화 (280fa35 — nonce 파라미터)
- [x] 라이트 모드 흰 탭바 (280fa35 — 다크 고정)
- [x] 오프라인 기록 캐시 (d63edb6 — 캐시본 + 오프라인 배너)
- [x] 기록 국가 필터 스테일 (280fa35 — 자동 리셋)
