      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.globeWrap}>
          <CountryGlobe
            ...
            // nonce so re-tapping the same country still re-syncs the map tab
            onSelectCountry={(country) => router.push(`/explore?country=${country}&t=${Date.now()}`)}
          />
        </View>

        {firstRun ? (
          <Pressable style={styles.onboardCard} onPress={() => router.push('/checkin')}>
